...
class FileRateLimiter {
    ...
    private $cooldown; // Tiempo mínimo entre solicitudes consecutivas (en segundos)

    public function __construct($limit = 5, $window = 1, $cooldown = 0.2) { // 5 solicitudes por segundo, cooldown de 200ms
        $this->limit = $limit;
