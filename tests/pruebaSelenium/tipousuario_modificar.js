...
// === TEST AUTOMATIZADO: MODIFICAR TIPO USUARIO ===
async function runTest() {
  ...
  try {
    ...
    testSteps.push('Modificar los datos del tipo usuario');
    ...
    console.log('Actualizando tipo usuario...');
    ...
    try {
      ...
      if (successText.includes('Rol modificado con éxito') || successText.includes('éxito')) {
      ...
      try {
        ...
        if (await tabla.isDisplayed()) {
          console.log('Tabla visible - Tipo usuario modificado exitosamente.');
        } else {
    ...
    console.log('Tipo usuario modificado exitosamente.');
    notes = 'Tipo usuario modificado exitosamente. Nuevo nombre: ' + nuevoNombre + ', Estado: Inactivo';
    status = 'p';
