...
const TEST_CASE_EXTERNAL_ID = 'Prueba-71';
...
// === TEST AUTOMATIZADO: ERROR AL MODIFICAR CATEGORIA DEJANDO INPUTS VACÍOS ===
async function runTest() {
  ...
  try {
    ...
    // === Paso 5: Dejar el campo vacío ===
    testSteps.push('Dejar el campo nombre vacío');
    console.log('Dejando campo vacío...');
