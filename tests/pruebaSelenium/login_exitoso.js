...
const TEST_CASE_EXTERNAL_ID = 'Prueba-81';
...
// === TEST AUTOMATIZADO: LOGIN EXITOSO ===
async function runTest() {
  ...
  try {
    ...
    if (currentUrl.includes('pagina=home')) {
      console.log('Login exitoso. Redirección a home confirmada.');
      testSteps.push('Redirección a home exitosa');
      notes = 'Login exitoso. Redirección a http://localhost:8080/proyectoIII/Proyecto-III/?pagina=home confirmada.';
      status = 'p';
    } else {
      throw new Error('No se redirigió a la página home. URL actual: ' + currentUrl);
    }
