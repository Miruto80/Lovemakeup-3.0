...
const TEST_CASE_EXTERNAL_ID = 'Prueba-56';
...
// === TEST AUTOMATIZADO: ERROR AL REGISTRAR PROVEEDOR CON CARÁCTER INVÁLIDO ===
async function runTest() {
  ...
  try {
    ...
    testSteps.push('Llenar datos con caracteres inválidos (nombre con número, correo sin @)');
