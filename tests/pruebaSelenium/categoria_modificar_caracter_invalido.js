...
const TEST_CASE_EXTERNAL_ID = 'Prueba-68';
...
// === TEST AUTOMATIZADO: ERROR AL MODIFICAR CATEGORIA CON CARÁCTER INVÁLIDO ===
async function runTest() {
  ...
  try {
    ...
    testSteps.push('Modificar con caracteres inválidos (nombre con número: Polv8)');
