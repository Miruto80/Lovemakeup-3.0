...
const TEST_CASE_EXTERNAL_ID = 'Prueba-45';
...
// === TEST AUTOMATIZADO: ERROR AL MODIFICAR DELIVERY POR INCUMPLIMIENTO DEL RANGO PERMITIDO DE CARACTERES ===
async function runTest() {
  ...
  try {
    ...
    testSteps.push('Modificar con valores fuera de rango (nombre muy corto: "Rh", teléfono muy corto: "042450719")');
