...
const TEST_CASE_EXTERNAL_ID = 'Prueba-83';
...
// === TEST AUTOMATIZADO: LOGIN INCORRECTO CONTRASEÑA ===
async function runTest() {
  ...
  try {
    ...
    // === Paso 2: Ingresar credenciales inválidas (contraseña incorrecta) ===
    testSteps.push('Ingresar credenciales con contraseña incorrecta');
    ...
    testSteps.push('Credenciales ingresadas: Cédula: 10200300, Contraseña: lara1234@ (incorrecta)');
    ...
    try {
      ...
      if ((fullText.includes('cedula') || fullText.includes('Cedula') || fullText.includes('Cédula')) && 
          (fullText.includes('clave') || fullText.includes('Clave') || fullText.includes('contraseña')) && 
          (fullText.includes('incorrecta') || fullText.includes('invalida') || fullText.includes('inválida'))) {
      ...
      if (e.message.includes('timeout') || e.message.includes('Unable to locate')) {
        ...
        try {
          ...
          if (errorText.includes('cedula') || errorText.includes('clave') || errorText.includes('incorrecta') || errorText.includes('invalida')) {
