...
const TEST_CASE_EXTERNAL_ID = 'Prueba-85';
...
// === TEST AUTOMATIZADO: LOGIN EXITOSO CLIENTE ===
async function runTest() {
  ...
  try {
    ...
    // === Paso 2: Ingresar credenciales de cliente ===
    testSteps.push('Ingresar credenciales de cliente');
    console.log('Ingresando credenciales de cliente...');
    ...
    await usuarioInput.sendKeys('30716541');
    ...
    console.log('Credenciales de cliente ingresadas correctamente.');
    testSteps.push('Credenciales ingresadas: Cédula: 30716541');
    ...
    if (currentUrl.includes('pagina=catalogo')) {
      console.log('Login exitoso. Redirección a catálogo confirmada.');
      testSteps.push('Redirección a catálogo exitosa');
      notes = 'Login exitoso. Redirección a http://localhost:8080/proyectoIII/Proyecto-III/?pagina=catalogo confirmada.';
      status = 'p';
    } else {
      throw new Error('No se redirigió a la página catálogo. URL actual: ' + currentUrl);
    }
