...
const TEST_CASE_EXTERNAL_ID = 'Prueba-46';
...
// === TEST AUTOMATIZADO: VER INFORMACIÓN DEL DELIVERY ===
async function runTest() {
  ...
  try {
    ...
    // === Paso 3: Seleccionar un delivery y hacer click en Ver información ===
    testSteps.push('Seleccionar un delivery y hacer click en Ver información');
    ...
    testSteps.push('Verificar que el modal muestra la información del delivery');
    ...
    if (modalText && modalText.length > 0) {
      ...
      testSteps.push('Modal de información abierto y muestra datos del delivery');
    } else {
      throw new Error('El modal no muestra información del delivery');
    }

    console.log('Información del delivery mostrada exitosamente.');
    notes = 'Información del delivery mostrada exitosamente en el modal.';
    status = 'p';
