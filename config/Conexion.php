...
class Conexion {
    ...
    public function __construct() {
        try {
            // Primera conexión
            $this->conex1 = new \PDO("mysql:host=".DB_HOST.";port=3307;dbname=".DB_NAME_1.";charset=utf8", DB_USER, DB_PASS);
            $this->conex1->setAttribute(\PDO::ATTR_ERRMODE, \PDO::ERRMODE_EXCEPTION);

            // Segunda conexión
            $this->conex2 = new \PDO("mysql:host=".DB_HOST.";port=3307;dbname=".DB_NAME_2.";charset=utf8", DB_USER, DB_PASS);
