    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="#">Finanza</a></li>
            ...
            <div class="card mb-4">
              <div class="card-header pb-0 div-oscuro-2">
                <div class="d-sm-flex align-items-center justify-content-between mb-5">
                  <h4 class="mb-0 texto-quinto"><i class="fa-solid fa-credit-card mr-2 icoM" style="color: #f6c5b4;"></i> Método de Pago</h4>
                  <?php if ($_SESSION["nivel_rol"] == 3 && tieneAcceso(13, 2)): ?>  
                  ...
                  <table class="table table-m table-bordered table-hover" id="myTable" width="100%" cellspacing="0">
                    ...
                    <tbody id="metodopagoTableBody">
                      <?php foreach ($metodos as $dato): ?>
                        ...
                        <td>
                         <?php if ($_SESSION["nivel_rol"] == 3 && tieneAcceso(13, 3)): ?>
