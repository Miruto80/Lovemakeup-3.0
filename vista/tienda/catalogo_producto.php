...
<button type="button" 
        ...
        class="md:hidden fixed bottom-20 left-4 z-40 bg-accent-fuchsia text-white px-4 py-3 rounded-full shadow-2xl flex items-center gap-2 text-xs font-bold hover:bg-pink-700 transition-all active:scale-95">
