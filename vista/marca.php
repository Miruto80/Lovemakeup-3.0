        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm">
              <a class="opacity-5 text-white" href="#">Inventario</a>
            </li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">
              Marca
            </li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Gestionar Marca</h6>
        </nav>
            ...
            <div class="card-header pb-0 div-oscuro-2">
              <div class="d-sm-flex align-items-center justify-content-between mb-5">
                <h4 class="mb-0 texto-quinto">
                  <i class="fa-solid fa-tag me-2 icoM" style="color: #f6c5b4;"></i>
                  Marca
                </h4>
              ...
              <div class="table-responsive">
                <table class="table table-m table-hover" id="myTable" width="100%" cellspacing="0">
                  <thead class="table-color">
                    <tr>
                      <th class="text-white text-center">Nombre de Marca</th>
        ...
        <div class="modal-content modal-producto">
          ...
          <div class="modal-header">
            <h5 class="modal-title fs-5" id="modalTitle">
              ...
              <span id="modalTitleText">Registrar marca</span>
            </h5>
          ...
          <div class="modal-body bg-s">
            <form id="u" autocomplete="off">
              ...
              <div class="seccion-formulario">
                <h6 class="texto-quinto"><i class="fas fa-tag"></i> Información de la marca</h6>
                <div class="row g-3">
                  <div class="col-md-12">
              ...
              <div class="col">
                <div class="info-box">
                  ...
                  <div class="info-content">
                    ...
                    <p>Las marcas ayudan a organizar los productos del sistema. Una buena categorización facilita la búsqueda y gestión del inventario.</p>
